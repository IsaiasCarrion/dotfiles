...
{"nvim-tree/nvim-web-devicons"}, -- Explorador de archivos (el "sidebar")
{
...
},
{
  "bfredl/nvim-ipy",
  config = function()
    require("nvim-ipy").setup({
      -- Aquí puedes configurar opciones del kernel
    })
  end,
},
{
...
-- Otros plugins que pueden ser útiles con Molten
{ "nvim-treesitter/nvim-treesitter" }, -- Para el resaltado de celdas
})
